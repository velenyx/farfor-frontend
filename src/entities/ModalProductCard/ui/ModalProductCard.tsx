...
export const ModalProductCard: FC<$TSFixMe> = ({ product }) => {
      ...
      <div className={styles.modal__wrapper}>
        ...
        <div className={styles.modal__content}>
          ...
          <div className={styles.kpfc}>
            ...
            <div className={styles.kpfc__item}>
              <div className={styles.kpfc__count}>{product.kpfc.proteins + ' г'}</div>
              <div className={styles.kpfc__description}>белки</div>
            </div>
            <div className={styles.kpfc__item}>
              <div className={styles.kpfc__count}>{product.kpfc.fats + ' г'}</div>
              <div className={styles.kpfc__description}>жиры</div>
            </div>
            <div className={styles.kpfc__item}>
              <div className={styles.kpfc__count}>{product.kpfc.carbohydrates + ' г'}</div>
              <div className={styles.kpfc__description}>углеводы</div>
            </div>
            <div className={styles.kpfc__item}>
              <div className={styles.kpfc__count}>{product.kpfc.calorie + ' г'}</div>
          ...
          <ProductBuy checkedFirst={checkedFirst} isTooltip={false} product={product} />
        </div>
      </div>
    </div>
  )
